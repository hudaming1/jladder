...
public class CreateCA {
	...
	public static void main(String[] args) throws Exception {
		KeyPairGenerator rsa = (KeyPairGenerator) KeyPairGenerator.getInstance("RSA", "BC");
		rsa.initialize(4096);
		...
		encoder.encode(certHolder.getEncoded(), 0, certHolder.getEncoded().length, System.out);
