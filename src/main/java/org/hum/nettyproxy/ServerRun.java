...
//		args = "nettyproxy.runmode=11 nettyproxy.port=3389 nettyproxy.outside_proxy_host=47.75.102.227 nettyproxy.outside_proxy_port=5432 nettyproxy.workercnt=96".split(" ");
//		args = "nettyproxy.runmode=12 nettyproxy.port=52996 nettyproxy.outside_proxy_host=localhost nettyproxy.outside_proxy_port=5432 nettyproxy.workercnt=96".split(" ");
		args = "nettyproxy.enableauthority=1 nettyproxy.runmode=1 nettyproxy.port=3389 nettyproxy.workercnt=96 nettyproxy.http_server_port=80 nettyproxy.http_server_url=http://127.0.0.1:80 nettyproxy.intercept-redirect=hudaming.com->127.0.0.1".split(" ");
